...
public class Main {
        ...
        switch(UserInputString()){
            case "Novel":
                ...
                for(int i=0;i<library.size();i++) {
                    if (searchNameNovel.equalsIgnoreCase(library.get(i).getNameBook())){
                        System.out.println("The novel "+library.get(i).getNameBook()+" will be deleted");
                        library.remove(i);
                        searchNameNovel="";
            ...
            case "Album":
                ...
                for(int i=0;i<library.size();i++) {
                    if (searchNameAlbum.equalsIgnoreCase(library.get(i).getNameBook())){
                        System.out.println("The album "+library.get(i).getNameBook()+" will be deleted");
                        library.remove(i);
                        searchNameAlbum="";
                        System.out.println("The album has been deleted");
                    }
    ...
    private static void ListBook(ArrayList<Books> library) {                                                              //Listare o carte anume
        ...
        switch(UserInputString()){
            case "Novel":
                ...
                for(int i=0;i<library.size();i++) {
                    if (searchNameNovel.equalsIgnoreCase(library.get(i).getNameBook())){
                        System.out.println("The reaserched novel is: "+library.get(i).getNameBook()+" | pages: "+library.get(i).getNrOfPagesBook()+" | book type: "+library.get(i).getTypeNovel());
                        searchNameNovel="";
                    }
                }
                if(searchNameNovel!=""){
            ...
            case "Album":
                ...
                for(int i=0;i<library.size();i++) {
                    if (searchNameAlbum.equalsIgnoreCase(library.get(i).getNameBook())){
                        System.out.println("The reaserched album is: "+library.get(i).getNameBook()+" | pages: "+library.get(i).getNrOfPagesBook()+" | quality of pages: "+library.get(i).getQualityOfPages());
                        searchNameAlbum="";
                    }
                }
                if(searchNameAlbum!=""){
